...
function AuthAuditSection({ events, stats, onOpenUsers }: { events: AuditEvent[], stats?: AuditStats | null, onOpenUsers: () => void }) {
...
export function RegisteredUsersDialog({ users, total, loading, onClose }: { users: RegisteredUser[], total: number, loading: boolean, onClose: () => void }) {
...
export function AuditView({ events, stats, onBack, onOpenUsers }: { events: AuditEvent[], stats?: AuditStats | null, onBack: () => void, onOpenUsers: () => void }) {
