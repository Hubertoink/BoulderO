...
function GroupDetailView({ groupId, spots, onBack, onOpenSpot, onOpenUserFeed, onSummaryChange }) {
  ...
  async function markGroupNotificationsRead() {
    try {
      await api(`/api/community/groups/${groupId}/notifications/read`, { method: 'POST' })
  ...
  useEffect(() => { if (active) void markGroupNotificationsRead() }, [active, groupId])
